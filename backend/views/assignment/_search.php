...
<div class="panel">
    ...
    <div class="panel-container show">
        <div class="panel-content">
            ...
            <div class="row">
                <div class="col-lg-3">
                    <?= $form->field($model, 'username')->textInput(['placeholder'=>'Nhập tên nhân viên, email, sđt'])->label(false) ?>
                </div>
                <div class="col-lg-2">
                ...
                <div class="col-lg-5">
                    <div class="form-group">
                        ...
                        <?= Html::a('<i class="fal fa-plus"></i> Thêm tài khoản', ['create'], ['class' => 'btn btn-success']) ?>
                    </div>
                </div>
            </div>
            <?php ActiveForm::end(); ?>
