...
$this->params['breadcrumbs']['description_page'] = 'Quản lý danh sách banner';
    ...
    <div class="card mb-g">
        <div class="card-body table-responsive">
            <?= GridView::widget([
                ...
                'emptyText' => 'Không có banner nào',
                'summary' => "<p class='summary_data'>Hiển thị {begin} - {end} trong tổng số <b>{totalCount}</b> banner</p>",
                    ...
                    'contentOptions' => ['class'=>'text-center'],
                        ...
                        'buttons' => [
                            ...
                            'delete' => function ($model, $url) use ( $controller){
                                return '<a title="Xoá" onclick="return confirm(\'Bạn có chắc chắn muốn xoá banner này?\')" href="/' . $controller . '/delete?id=' . $url->id . '"><i class="fal fa-trash"></i></a>';
                            }
                        ],
                    ],
                ],
