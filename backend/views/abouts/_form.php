            ...
            <div class="panel" style="width:100%">
                ...
                <div class="panel-container show">
                    <div class="panel-content row">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group mb-0">
                                ...
                                <div class="custom-file">
                                    <input type="file" name="avatar" accept="image/*" class="custom-file-input file-upload-ajax" data-folder="images/abouts" id="imgUpload">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group mb-0">
                                <label class="control-label">Ảnh đại diện (ảnh nhỏ)</label>
                                <div class="custom-file">
                                    <input type="file" name="avatar" accept="image/*" class="custom-file-input file-upload-ajax" data-folder="images/abouts" id="imgUploads">
                                    <label class="custom-file-label" for="imgUploads"><?= $model->avatar != '' ? $model->avatar : 'Chọn ảnh' ?></label>
                                </div>
