    ...
    <div class="panel-container show">
        <div class="panel-content">
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <?php echo $form->field($model, 'status')->dropDownList(Yii::$app->params['orderStatus'],['prompt'=>'Tình trạng đơn hàng', 'class' => 'form-control'])->label(false) ?>
                </div>
                <div class="col-lg-3">
                    <?php echo $form->field($model, 'affliate_id')->dropDownList($listSale,['prompt'=>'Tài khoản sale', 'class' => 'form-control'])->label(false) ?>
                </div>
                <div class="col-lg-3">
