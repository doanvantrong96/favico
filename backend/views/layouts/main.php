                                ...
                                <div class="dropdown-menu dropdown-menu-animated dropdown-lg">
                                    <div class="dropdown-header bg-trans-gradient d-flex flex-row py-4 rounded-top">
                                        <div class="d-flex flex-row align-items-center mt-1 mb-1 color-white">
                                            <span class="mr-2">
                                                <img src="/img/demo/avatars/logo.png" class="rounded-circle profile-image" alt="<?= $user->fullname ?>">
                                            </span>
                                    ...
                                    <a href="/employee/change-password" class="dropdown-item fw-500 pt-3 pb-3">
                                        <span data-i18n="drpdwn.reset_layout">Đổi mật khẩu</span>
                                    </a>
                                    <div class="dropdown-divider m-0"></div>
                ...
                window.onload = function() {
                    if( $('.editor').length > 0 ){
                        tinymce.init({
                            ...
                            toolbar_sticky: true,
                            fontsize_formats: "8px 9px 10px 11px 12px 14px 16px 18px 20px 22px 24px 26px 28px 30px 32px 34px 36px 38px 40px 48px 72px",
                            image_advtab: true,
                            image_caption: true,
