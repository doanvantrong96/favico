...
$this->params['breadcrumbs']['description_page'] = 'Loại sản phẩm';
    ...
    <div class="card mb-g">
        <div class="card-body table-responsive">
            <?= GridView::widget([
                ...
                'emptyText' => 'Không có loại sản phẩm',
                'summary' => "<p class='summary_data'>Hiển thị {begin} - {end} trong tổng số <b>{totalCount}</b> loại sản phẩm</p>",
